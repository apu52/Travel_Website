...
const url =
  "https://api.shecodes.io/weather/v1/forecast?query=Kashmir&key=057314561f8344abb8d5d80t6761o6ae&units=metric";
...
/*
const url = 'https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Jammu%20and%20kashmir&country=India';
const options = {
    method: 'GET',
    headers: {
